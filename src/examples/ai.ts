...
<Text text: "8 Different Specialized" position: { x: 89 y: 140 } dimension: { width: 610 height: 58 } fontFamily: "Black Ops One" classes: "text-wrap mx-auto break-words truncate text-primary-content w-[130px] bg-linear-to-t text-5xl" />
<Text text: "AI Models" position: { x: 673 y: 142 } dimension: { width: 304 height: 62 } fontFamily: "Black Ops One" classes: "text-wrap mx-auto break-words truncate text-success w-[130px] bg-linear-to-t text-5xl" />
<Text text: "LLM" position: { x: 141 y: 217 } dimension: { width: 107 height: 52 } fontFamily: "Black Ops One" classes: "text-wrap mx-auto break-words truncate text-primary-content text-5xl w-[130px] bg-linear-to-t" />
<Text text: "LCM" position: { x: 400 y: 218 } dimension: { width: 140 height: 53 } fontFamily: "Black Ops One" classes: "text-wrap mx-auto break-words truncate text-primary-content text-5xl w-[130px] bg-linear-to-t" />
<Text text: "LAM" position: { x: 686 y: 217 } dimension: { width: 124 height: 53 } fontFamily: "Black Ops One" classes: "text-wrap mx-auto break-words truncate text-primary-content text-5xl w-[130px] bg-linear-to-t" />
<Text text: "MoE" position: { x: 944 y: 217 } dimension: { width: 150 height: 44 } fontFamily: "Black Ops One" classes: "text-wrap mx-auto break-words truncate text-primary-content text-5xl w-[130px] bg-linear-to-t" />
...
position: { x: 452 y: 530 }
/>
<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
</svg>\` 
position: { x: 991 y: 527 }
/>
<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
</svg>\` 
position: { x: 159 y: 1148 }
/>
<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
</svg>\` 
position: { x: 461 y: 1142 }
/>
...
position: { x: 230 y: 758 }
/>

<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke-width="1" class="size-10 rounded-full bg-accent-content fill-(--color-accent) p-1">
...
position: { x: 448 y: 356 }
/>

<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke-width="1" class="size-10 rounded-full bg-accent-content fill-(--color-accent) p-2">
  <path  stroke-linecap="round" stroke-linejoin="round"
...
position: { x: 449 y: 468 }
/>

<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-1">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z" />
</svg>\` 
position: { x: 739 y: 762 }
/>

<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-1">
  <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
</svg>\` 
position: { x: 126 y: 757 }
/>

<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-1">
  <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
</svg>\` 
position: { x: 1043 y: 758 }
/>

<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-10 rounded-full bg-accent-content stroke-(--color-accent) p-1">
  <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
</svg>\` 
position: { x: 1045 y: 834 }
/>
...
<Text text: "Input" position: { x: 485 y: 302 } dimension: { width: 51 height: 18 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Diffusion" position: { x: 489 y: 476 } dimension: { width: 81 height: 21 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Sentence Segmentation" position: { x: 493 y: 359 } dimension: { width: 91 height: 39 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Sonar Embedding" position: { x: 493 y: 418 } dimension: { width: 91 height: 39 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Input" position: { x: 1029 y: 299 } dimension: { width: 51 height: 18 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Input Processing" position: { x: 764 y: 292 } dimension: { width: 86 height: 35 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Input Processing" position: { x: 490 y: 768 } dimension: { width: 86 height: 35 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Output" position: { x: 495 y: 540 } dimension: { width: 51 height: 18 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Output" position: { x: 1032 y: 540 } dimension: { width: 51 height: 18 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Output" position: { x: 204 y: 1158 } dimension: { width: 51 height: 18 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Output" position: { x: 505 y: 1153 } dimension: { width: 51 height: 18 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Text Input" position: { x: 782 y: 771 } dimension: { width: 82 height: 19 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Text Input" position: { x: 270 y: 767 } dimension: { width: 82 height: 19 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Text Encoder" position: { x: 273 y: 829 } dimension: { width: 82 height: 19 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Image Input" position: { x: 1087 y: 767 } dimension: { width: 82 height: 19 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Image Input" position: { x: 68 y: 763 } dimension: { width: 52 height: 40 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
<Text text: "Image Encoder" position: { x: 1075 y: 844 } dimension: { width: 122 height: 23 } fontFamily: "Roboto Mono" classes: "text-wrap mx-auto break-words truncate text-primary-content text-1xl" />
 
<Author src: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1480&amp;q=80" position: { x: 1047 y: 127 } dimension: { width: 203 height: 68 } name: "Sagar Shelar" caption: "Web Developer" imageClasses: "inline-block shrink-0 rounded-full" captionClasses: "text-base-content/50 text-sm" nameClasses: "text-base-content font-semibold" nameFontFamily: "Allerta" captionFontFamily: "Roboto Mono" classes: "shrink-0 group block flex items-center gap-4 bg-base-300 rounded-2xl p-2" />
...
<Box type: Box1 position: { x: 0 y: 0 } dimension: { width: 214 height: 222 } classes: "border-solid border-secondary bg-neutral-content border-4 rounded-lg" />
<Text text: "1" position: { x: 84 y: -17 } dimension: { width: 40 height: 40 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-secondary  border-solid border-secondary bg-neutral-content border-4 rounded-full text-lg" />
<Text text: "• Advanced AI trained on vast datasets." position: { x: 3 y: 118 } dimension: { width: 193 height: 33 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-neutral text-xs" />
<Text text: "• Enables human-like language understanding and generation" position: { x: 4 y: 155 } dimension: { width: 196 height: 32 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-neutral text-xs" />
<Text text: "LLM " position: { x: 55 y: 23 } dimension: { width: 100 height: 20 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-secondary bg-linear-to-t font-bold" />
<Svg code: \`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  xml:space="preserve" class="size-15 rounded-full fill-secondary">
  <g>
...
position: { x: 73 y: 42 } dimension: { width: 62 height: 56 } 
/>


<Box type: Box1 position: { x: 230 y: 0 } dimension: { width: 214 height: 222 } classes: "border-solid border-primary bg-neutral-content border-4 rounded-lg" />
<Text text: "2" position: { x: 308 y: -17 } dimension: { width: 40 height: 40 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-primary  border-solid border-primary bg-neutral-content border-4 rounded-full text-lg" />
<Text text: "• Innovative neural networks" position: { x: 227 y: 132 } dimension: { width: 193 height: 33 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-neutral text-xs" />
<Text text: "• Processes sequential data for enhanced language tasks." position: { x: 231 y: 152 } dimension: { width: 196 height: 32 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-neutral text-xs" />
<Text text: "Transformers " position: { x: 280 y: 25 } dimension: { width: 100 height: 20 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-primary bg-linear-to-t font-bold" />


<Box type: Box1 position: { x: 461 y: 0 } dimension: { width: 214 height: 222 } classes: "border-solid border-success bg-neutral-content border-4 rounded-lg" />
<Text text: "3" position: { x: 544 y: -17 } dimension: { width: 40 height: 40 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-success  border-solid border-success bg-neutral-content border-4 rounded-full text-lg" />
<Text text: "Prompt Engineering " position: { x: 524 y: 20 } dimension: { width: 81 height: 37 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-success bg-linear-to-t font-bold" />

<Box type: Box1 position: { x: 688 y: 0 } dimension: { width: 214 height: 222 } classes: "border-solid border-info bg-neutral-content border-4 rounded-lg" />
<Text text: "4" position: { x: 769 y: -18 } dimension: { width: 40 height: 40 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-info border-solid border-info bg-neutral-content border-4 rounded-full text-lg" />
<Text text: "Fine Tuning" position: { x: 746 y: 24 } dimension: { width: 80 height: 24 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-info bg-linear-to-t font-bold" />

<Box type: Box1 position: { x: 0 y: 270 } dimension: { width: 214 height: 222 } classes: "border-solid border-secondary bg-neutral-content border-4 rounded-lg" />
<Text text: "5" position: { x: 81 y: 254 } dimension: { width: 36 height: 36 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-secondary  border-solid border-secondary bg-neutral-content border-4 rounded-full text-lg" />



<Box type: Box1 position: { x: 230 y: 270 } dimension: { width: 214 height: 222 } classes: "border-solid border-primary bg-neutral-content border-4 rounded-lg" />
<Text text: "6" position: { x: 314 y: 253 } dimension: { width: 40 height: 40 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-primary  border-solid border-primary bg-neutral-content border-4 rounded-full text-lg" />


<Box type: Box1 position: { x: 459 y: 270 } dimension: { width: 214 height: 222 } classes: "border-solid border-success bg-neutral-content border-4 rounded-lg" />
<Text text: "7" position: { x: 548 y: 252 } dimension: { width: 40 height: 40 } fontFamily: "Roboto Slab" classes: "text-wrap mx-auto break-words truncate text-primary  border-solid border-primary bg-neutral-content border-4 rounded-full text-lg" />

<Box type: Box1 position: { x: 684 y: 270 } dimension: { width: 214 height: 222 } classes: "border-solid border-info bg-neutral-content border-4 rounded-lg" />


<Box type: Box1 position: { x: 0 y: 540 } dimension: { width: 214 height: 222 } classes: "border-solid border-secondary bg-neutral-content border-4 rounded-lg" />
<Box type: Box1 position: { x: 228 y: 540 } dimension: { width: 214 height: 222 } classes: "border-solid border-primary bg-neutral-content border-4 rounded-lg" />
<Box type: Box1 position: { x: 454 y: 540 } dimension: { width: 214 height: 222 } classes: "border-solid border-success bg-neutral-content border-4 rounded-lg" />
<Box type: Box1 position: { x: 680 y: 540 } dimension: { width: 214 height: 222 } classes: "border-solid border-info bg-neutral-content border-4 rounded-lg" />
